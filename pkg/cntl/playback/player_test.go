...
func TestCalcRenderSpeed(t *testing.T) {
	exp := []struct {
		...
		{cntl.BarChange{BarParams: cntl.BarParams{Speed: 60, NoteValue: 4}}, time.Minute / 960},
		{cntl.BarChange{BarParams: cntl.BarParams{Speed: 60, NoteValue: 8}}, time.Minute / 960},
	}
